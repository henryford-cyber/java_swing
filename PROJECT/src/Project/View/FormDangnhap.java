...
package Project.DAO.CTL_Dangnhap;

 
import Project.Model.Taikhoan;
import Project.Service.TaiKhoanService1;
...
public class FormDangnhap extends javax.swing.JDialog {
    ...
    TaiKhoanService1 taiKhoanService1;
    Taikhoan tK;
...
//        controller.setEvent();
        ...
        taiKhoanService1 = new TaiKhoanService1();
        listTK = taiKhoanService1.getAllTaiKhoan();
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (isSucces) {
            ...
            Main1JFrame Frame1 = new Main1JFrame();
            Frame1.setSize(1565, 765);
    ...
    private void txtUserFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtUserFocusLost
        ...
        if (tendangnhap.length() > 0) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Tên tài khoảng không được để trống!");
        }
