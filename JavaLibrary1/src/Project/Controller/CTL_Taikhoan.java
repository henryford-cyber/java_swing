...
public class CTL_Taikhoan {
   ...
   private JPasswordField txtPass;
    ...
    public CTL_Taikhoan(Dialog dialog, JButton btnLogin, JTextField txtUser,JPasswordField txtPass, JLabel jlbMsg) {
        this.dialog = dialog;
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    if (txtUser.getText().length() == 0
                        ...
                        Taikhoan tk = taikhoanService.login(txtUser.getText(), txtPass.getText());
                        if (tk == null) {
