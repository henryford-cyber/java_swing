...
//           JOptionPane.showMessageDialog(null, cols);
    ...
    private void initComponents() {
        ...
        dangky.setForeground(new java.awt.Color(51, 51, 51));
        ...
        nut_cap_nhat.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        nut_cap_nhat.setForeground(new java.awt.Color(51, 51, 51));
        ...
        nut_xoa.setForeground(new java.awt.Color(51, 51, 51));
        nut_xoa.setText("Xóa");
        ...
        combox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Nam", "Nu", " ", " " }));
...
//           bang_data.setModel(DbUtils.resultSetToTableModel(rs));
            while (rs.next()) {
                Vector user = new Vector();
                user.addElement(rs.getString("mataikhoan"));
