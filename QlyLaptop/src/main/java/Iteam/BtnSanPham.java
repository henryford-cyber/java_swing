...
public class BtnSanPham {
    ...
    public static void themSP(int masp, int loaisp, String tensp, double gia, String linhkien, String khuyenmai, String thongso, String baiviet, String baohanh, int soluong) throws ClassNotFoundException, SQLException {
