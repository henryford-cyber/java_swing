...
public class Thongke_chuan extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            JDBCCategoryDataset dataset=new JDBCCategoryDataset(MySqlConnect.ConnectDb(), query);
            JFreeChart chart = ChartFactory.createBarChart3D("Thống kê chi tiết","Mã Sản Phẩm", "Giá bán", dataset, PlotOrientation.VERTICAL, true, true, true);
            BarRenderer renderer=null;
            CategoryPlot plot=null;
            renderer=new BarRenderer3D();
...
try {
            ...
            JDBCCategoryDataset dataset=new JDBCCategoryDataset(MySqlConnect.ConnectDb(), query);
            JFreeChart chart = ChartFactory.createBarChart3D("Thống kê chi tiết","Loại sản phẩm", "Số lượng", dataset, PlotOrientation.VERTICAL, true, true, true);
            BarRenderer renderer=null;
            CategoryPlot plot=null;
            renderer=new BarRenderer3D();
