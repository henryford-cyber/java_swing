...
public class TaikhoanJPanel extends javax.swing.JPanel {
    ...
    public TaikhoanJPanel() {
        ...
        dfModel.setColumnIdentifiers(new Object[]{"NAME", "VAITRO"});
    ...
    private void initTable() {
        ...
        dfModel.setColumnIdentifiers(new String[]{"NAME",  "VAITRO"});
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtAccountname, javax.swing.GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE))
                        .addGap(56, 56, 56)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        try {
            ...
            taikhoan.setVaitro(txtVaitro.getText());
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            ...
            if (passsword.equals(confirm)) {
                ...
                Taikhoan tk = new Taikhoan(id, txtAccountname.getText(), txtPasswordacc.getText(), txtVaitro.getText());
                dao.update(tk);
                loadSinhvien();
    ...
    private void tblAccountMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblAccountMouseClicked
        ...
        if (row >= 0) {
            ...
            txtVaitro.setText(tblAccount.getValueAt(row, 2).toString());
        }
