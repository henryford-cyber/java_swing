...
public class Tailogin extends javax.swing.JFrame {
 ...
 public void close() {
    ...
    private void initComponents() {
        ...
        txt_tendangnhap.setBounds(508, 245, 174, 34);
        ...
        txt_matkhau.setBounds(508, 298, 174, 34);

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/dialog/thong.png"))); // NOI18N
        getContentPane().add(jLabel2);
        jLabel2.setBounds(380, 440, 280, 40);

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/dialog/chuan_tai.gif"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(470, 200, 90, 30);

        nut_dang_ky.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/dialog/nut_dang_ky.png"))); // NOI18N
        ...
        nut_dang_ky.setBounds(420, 490, 186, 38);

        nut_dang_nhap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/dialog/nut_dang_nhap.png"))); // NOI18N
        ...
        nut_dang_nhap.setBounds(350, 370, 331, 40);

        hinh_nen.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        hinh_nen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/dialog/chuan_91.png"))); // NOI18N
        hinh_nen.setAutoscrolls(true);
        hinh_nen.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        hinh_nen.setIconTextGap(1);
        hinh_nen.setName(""); // NOI18N
        hinh_nen.setOpaque(true);
        getContentPane().add(hinh_nen);
        hinh_nen.setBounds(0, 0, 1800, 1125);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/dialog/txt_login.png"))); // NOI18N
        getContentPane().add(jLabel3);
        jLabel3.setBounds(270, 550, 460, 80);
...
//            conn.close();
//        } catch (Exception e) {
//            JOptionPane.showMessageDialog(null, "sai owr ddaay");
//        }
        // TODO add your handling code here:
